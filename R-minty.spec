...
Version  : 0.0.5
Release  : 4
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/minty_0.0.5.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/minty_0.0.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736299992
